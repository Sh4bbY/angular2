...
export const routes: Routes = [
    ...
    { path: 'pixi/game-of-life', component: GameOfLifeComponent },
    { path: 'pixi/shooter', component: ShooterComponent },
    { path: 'pixi/physics', component: PhysicsComponent },
    { path: 'three/sphere', component: SphereComponent },
